 ...
 * @author Anderson
 */
public class ConsultaPacienteDialog extends javax.swing.JDialog {

    /**
     * Creates new form ConsultaPacienteDialog
     */
    public ConsultaPacienteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlBaseLayout.setVerticalGroup(
            ...
            .addGroup(pnlBaseLayout.createSequentialGroup()
                ...
                .addComponent(scpPacientes, javax.swing.GroupLayout.DEFAULT_SIZE, 375, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(tblPacientes.getSelectedRow() < 0) {
            Mensagens.showMessageWarning(this, "Nenhum paciente selecionado!");
        } else {
            idSelecionado = (Long) tblPacientes.getValueAt(tblPacientes.getSelectedRow(), 0);
            
            PacienteDialog dialog = new PacienteDialog((Frame) this.getParent(), true, idSelecionado);
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        if(tblPacientes.getSelectedRow() < 0) {
            ...
            if(Mensagens.showMessageQuestion(this, "Deseja realmente deletar?") == JOptionPane.YES_OPTION) {
                idSelecionado = (Long) tblPacientes.getValueAt(tblPacientes.getSelectedRow(), 0);
                resultado = PacienteController.getInstance().deletePacienteById(idSelecionado);
                if (resultado == true) {
                    Mensagens.showMessageError(this, "Falha ao deletar o paciente!");
                } else {
                    Mensagens.showMessageInfo(this, "Paciente deletado com sucesso!");
                    carregarDadosTabelaPaciente();
                }
            } else {
    ...
    private void btnDeletarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarTodosActionPerformed
        ...
        if(tblPacientes.getRowCount()==0){
            Mensagens.showMessageWarning(this, "Não existem pacientes cadastrados!");
        } else {
            if(Mensagens.showMessageQuestion(this, "Deseja realmente deletar todos os pacientes?") == JOptionPane.YES_OPTION) {
                qtde = PacienteController.getInstance().deleteAllPacientes();
                Mensagens.showMessageInfo(this, qtde + " pacientes foram deletados com sucesso!");
                carregarDadosTabelaPaciente();
            } else {
                tblPacientes.clearSelection();
            }
    ...
    private void carregarDadosTabelaPaciente() {
        ...
        List<Paciente> pacientes = PacienteController.getInstance().readAllPacientes();
...
//        }
        ...
        for (Paciente paciente : pacientes) {           
            Object[] linha = {paciente.getId(), paciente.getNome(),
            paciente.getCpf(), dateFormat.format(paciente.getDataNascimento())};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaPacienteDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaPacienteDialog dialog = new ConsultaPacienteDialog(new javax.swing.JFrame(), true);
